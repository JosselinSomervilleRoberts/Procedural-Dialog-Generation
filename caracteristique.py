...
class Caracteristique:
  ...
  def getAvailable():
    return ["politesse", "beaute", "compassion", "couleur", "taille", "tailleH", "metier", "ageH", "mysterieux", "bavard", "curiosite", "colere", "hésitation", "memoire", "blesse"]
  ...
  def __init__(self, lib=None, types=None, intervals=None, keepLib=True, name=None):
    if not(name is None):
      ...
      if name == "memoire" : Caracteristique.__init__(self, "mémoire",[liste_types["caractere"]])
      if name == "blesse" : Caracteristique.__init__(self, "blessé",[liste_types["caractere"]])
    else:
